        ...
        <div class="mx-auto max-w-7xl px-6 pb-10 pt-16">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="/aiplatform"
                                        class="text-md leading-6 text-gray-300 hover:text-gray-50">Websites Traffic
                                    </a>
                                </li>
                                <li>
                                    <a href="/aialgorithms"
                                        class="text-md leading-6 text-gray-300 hover:text-gray-50">Websites Traffic Analysis
                                    </a>
                                </li>
                                <li>
            ...
            <div class="mt-16 border-t border-gray-400/30 pt-8 sm:mt-20 lg:mt-24">
                <div class="text-md text-center text-white">
                    ...
                    <span class="text-gray-50">♥</span> by US
                    <a rel="noopener" href="/">Different Webs
                    </a>
                </div>
            </div>
        </div>
