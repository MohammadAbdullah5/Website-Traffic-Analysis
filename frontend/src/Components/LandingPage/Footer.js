...
const Footer = () => {
  return (
    ...
    <div className="container mx-auto p-0 md:p-8 xl:px-0" id='contactUs'>
        <div className="mx-auto max-w-7xl px-6 pb-10 pt-16">
                    ...
                    <div>
                        <a href="/">
                            <div className="flex items-center space-x-2 text-2xl font-medium">
                                ...
                                <span className="text-white">SiteFlow Analytics</span>
                            </div>

                        </a>
                    </div>
                    <div className="max-w-md pr-16 text-md text-gray-200">Elevate your business strategy with our website traffic analysis platform, offering intuitive visualizations of diverse website metrics. Gain actionable insights into traffic trends, audience engagement, and competitive benchmarks, empowering you to make informed decisions and drive growth.
                    </div>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" className="mt-6 space-y-4">
                                <li>
                                    <a href="/aiplatform"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">Websites Traffic
                                    </a>
                                </li>
                                <li>
                                    <a href="/aialgorithms"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">Websites Traffic Analysis
                                    </a>
                                </li>
                                <li>
            ...
            <div className="mt-16 border-t border-gray-400/30 pt-8 sm:mt-20 lg:mt-24">
                <div className="text-md text-center text-white">
                    Copyright © 2024 .
                    <a rel="noopener" href="/">SiteFlow Analytics
                    </a>
                </div>
            </div>
        </div>
