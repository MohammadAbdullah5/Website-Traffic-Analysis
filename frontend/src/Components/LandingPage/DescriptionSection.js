...
const DescriptionSection = () => {
  return (
    <>
      <div className="bg-gray-700 p-4 min-h-screen" id='about'>
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
    <div className="md:w-2/3 lg:w-1/2 mt-12 text-gray-100">
      ...
      <h2 className="my-8 text-2xl font-bold text-white md:text-4xl">About US</h2>
    ...
    <div
      ...
      <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            <h5 className="text-xl font-semibold text-white transition group-hover:text-secondary">Project</h5>
            <p className="text-gray-300">We have designed the system of Website Traffic Analysis</p>
          </div>
        </div>
      </div>
      <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            <h5 className="text-xl font-semibold text-white transition group-hover:text-secondary">Purpose</h5>
            <p className="text-gray-300">This system would provide valuable insights into user interactions to the website</p>
          </div>
        </div>
      </div>
      <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            <h5 className="text-xl font-semibold text-white transition group-hover:text-secondary">Insights</h5>
            <p className="text-gray-300">We deliver a platform that empowers informed decision-making, driving sucess with clarity and precision</p>
          </div>
        </div>
      </div>
    </div>
